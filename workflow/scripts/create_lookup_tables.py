                        ...
                        for experiment in model.iterdir():
                            if experiment.is_dir() and experiment.parts[-1] in experiments:
                                ...
                                for variant in experiment.iterdir():
                                    if variant.is_dir() and variant.parts[-1].startswith(('.','RETRACTED'))==False:
                                        ...
                                        for table_id in variant.iterdir():
                                            if table_id.is_dir():
                                                ...
                                                lookup_dir[activity][model_name][experiment_name][variant_name][table_id.parts[-1]] = {'gl':list_gl}
